...
#'   product ion mass-to-charge ratios from the precursor \emph{m/z} in a matrix
#'   format analogous to the \code{spectrum} slot
#'
#' @export
...
#'
#' @param x An object of class \code{\link[MSnbase:Spectrum-class]{Spectrum}} or
#'   \code{\link[MSnbase:Spectrum-class]{Spectrum2}}
#'
